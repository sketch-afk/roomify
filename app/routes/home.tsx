...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Roomify - AI-Powered Architectural Visualizer" },
    { name: "description", content: "AI-first design environment to visualize and render architectural projects." },
  ];
}
                  ...
                  <div className="card-body">
                    <div>
                      ...
                      <div className="meta">
                        ...
                        <span>Made By {userName ?? "Community"}</span>
                      </div>
                    </div>
                    <div className="arrow">
